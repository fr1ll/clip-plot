...
def autocontrast_preserve_lightness(img:pil_image, cutoff:float=0.)->pil_image:
    '''
    apply PIL's autocontrast function, but preserve average lightness before and after
