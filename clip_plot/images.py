...
# %% auto 0
__all__ = ['PILLoadTruncated', 'load_image', 'resize_to_max_side', 'resize_to_height', 'channel_extrema', 'autocontrast',
...
def channel_extrema(x:np.array):
    '''QC function to print out channel extrema from numpy array'''
